...
{{PROJECT_NAME}}는 {{PROJECT_ONE_LINE_GOAL}}입니다.
...
현재 이 저장소는 Unity 프로젝트와 Git 저장소를 기준으로 최소 Codex 하네스를 초기화하는 단계입니다. Gameplay 구현은 아직 시작하지 않았습니다.

## 실행 방법

1. Unity {{UNITY_VERSION}}에서 저장소 루트 폴더를 엽니다.
