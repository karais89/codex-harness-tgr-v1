...
- [ ] M5-03: `잡초`, `시든 꽃`, `더러운 타일` 복구 대상이 있습니다.
  ...
  - 완료 증거: 세 복구 대상 오브젝트 이름과 시작 시점 표시 여부를 기록합니다.
...
- 다음 조치: 시작 시점부터 보이는 `잡초`, `시든 꽃`, `더러운 타일`, 세 대상 완료 조건, `Garden Restored` 완료 표시를 추가하고 Play Mode에서 시작부터 완료까지 검증합니다.
